...
from agents.DRO_KL_experts import Optimization_Modeling, Transfer_Modeling, Code_Generating
from agents.code_repair import Code_Repair
from utils import save_txt, extract_python_code, safe_exec, safe_exec_with_flag

def pipline(result_dir: str, problem: Dict, data_desciption: Dict, train_dir: str, test_dir: str, model: str, temperature: float) -> None:
    ...
    if os.path.exists(code_path):
        ...
        code_response = code_generating.run(problem, data_desciption, row, initial_model, math_model, train_dir, test_dir, result_dir)
