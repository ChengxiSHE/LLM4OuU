...
from agents.RO_Budget_experts import Optimization_Modeling, Code_Generating, Transfer_Modeling
...
def pipline(result_dir: str, gamma, problem: Dict, data_discription: Dict, train_dir: str, test_dir: str, model: str, temperature: float) -> None:
    ...
    if os.path.exists(math_model_path):
        ...
        math_model = transfer_modeling.run(problem, row, gamma, initial_model)
    ...
    if os.path.exists(code_path):
        ...
        code_response = code_generating.run(problem, data_discription, row, gamma, initial_model, math_model, test_dir, result_dir, train_dir, d_bar)
